...
const PritTemplate = ({
  ...
  return (
    <main
      className='z-[60] fixed bg-black/50 backdrop-filter backdrop-blur-lg grid place-items-center w-full h-full top-0 left-0'
      id='print-area'
    >
      <section
      ...
      >
        ...
        <h4
          className='text-slate-200 font-semibold text-lg py-6'
        >
          Name : {name}
        </h4>
        <div
          className='text-slate-200 font-semibold text-lg pb-6'
        >
          <p>
